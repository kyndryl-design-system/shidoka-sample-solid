...
import SwitcherIcon from '@kyndryl-design-system/shidoka-foundation/assets/svg/switcher.svg?component-solid';
import userAvatarIcon24 from '@carbon/icons/es/user--avatar/24';
import userAvatarIcon20 from '@carbon/icons/es/user--avatar/20';

function App() {
  return (
    <kyn-ui-shell>
      <kyn-header divider="" apptitle="Shidoka Solid">
        <kyn-header-panel slot="left" heading="Panel Heading">
          <SwitcherIcon slot="button" />

          <kyn-header-panel-link href="javascript:void(0)">
            <kd-icon slot="button" icon={userAvatarIcon24}></kd-icon>
            Link 1
      ...
      <kyn-local-nav>
        <kyn-local-nav-link href="javascript:void(0)" active="">
          <kd-icon slot="icon" icon={userAvatarIcon20}></kd-icon>
          Link 1
        </kyn-local-nav-link>
      ...
      <main>
        <div class="kd-grid">
          <div class="kd-grid__col--sm-4 kd-grid__col--md-8 kd-grid__col--lg-12">
            <h1 class="kd-type--headline-03">Shidoka Solid Sample App</h1>
          </div>
